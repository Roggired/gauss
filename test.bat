...
java -jar build\libs\gauss-1.0.jar tests\test4
java -jar build\libs\gauss-1.0.jar tests\test5
java -jar build\libs\gauss-1.0.jar tests\test6
java -jar build\libs\gauss-1.0.jar tests\test7